...
yticklabels([1 size(sortedMatrix_B,1)])%, size(sortedMatrix_B,1)])

saveas(fig,fullfile(save_dir,'fig_1i.fig'),'fig')
saveas(fig,fullfile(save_dir,'fig_1i.pdf'),'pdf')
saveas(fig,fullfile(save_dir,'fig_1i.png'),'png')
